<script lang="ts">
  import { gameState, toggleSound } from '$lib/stores/gameStore'
  import { currentUser } from '$lib/utils/userManager'
  import { audioManager } from '$lib/utils/AudioManager'
  import StartupScreen from '$lib/screens/StartupScreen.svelte'
  import UserSelectionScreen from '$lib/screens/UserSelectionScreen.svelte'
  ...
  import DebugTools from '$lib/screens/DebugTools.svelte'
  import QuickPlay from '$lib/screens/QuickPlay.svelte'
  import StoryModeMenu from '$lib/screens/story-mode/StoryModeMenu.svelte'
  import StoryModePlay from '$lib/screens/story-mode/StoryModePlay.svelte'
  import ModalWrapper from '$lib/components/ModalWrapper.svelte'
  import GamePadIndicator from '$lib/components/GamePadIndicator.svelte'
