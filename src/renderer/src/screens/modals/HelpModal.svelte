...
<div
  class="help--modal fixed w-full max-w-md rounded-xl bg-white/10 space-1-bg p-6 pt-8 z-[999] top-1/2 left-1/2 -translate-1/2"
  in:fly={{ y: 200, duration: 500 }}
>
  <div class="content flex flex-col items-center justify-center gap-4">
    <h2 class="title text-2xl uppercase glow-text-2">Help</h2>
