<script lang="ts">
  ...
  import { setDifficulty } from '$lib/stores/gameStore'
  import { StorageManager } from '$lib/utils/storageManager'
  import type { GameSettings } from '$lib/types/gameTypes'
  ...
  <div class="content flex flex-col gap-6">
    ...
    <div class="tab-content min-h-[300px]">
      {#if activeTab === 'audio'}
        <div class="flex flex-col gap-6">
          <div class="setting-item">
            <label for="master-volume" class="flex justify-between items-center mb-2">
          ...
          <div class="setting-item">
            <label for="music-volume" class="flex justify-between items-center mb-2">
          ...
          <div class="setting-item">
            <label for="sfx-volume" class="flex justify-between items-center mb-2">
      ...
      {#if activeTab === 'gameplay'}
        <div class="flex flex-col gap-6">
          <div class="setting-item">
            <div class="block text-lg mb-3">Difficulty</div>
      ...
      {#if activeTab === 'gamepad'}
        <div class="flex flex-col gap-4">
          ...
          <div class="setting-item">
            <label for="gamepad-deadzone" class="flex justify-between items-center mb-2">
